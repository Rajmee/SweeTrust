...
import 'package:sweet_trust/src/widgets/button.dart';
import 'package:sweet_trust/src/widgets/show_dailog.dart';
import 'package:scoped_model/scoped_model.dart';

class AddSweetItemsPage extends StatefulWidget {
  final Food food;

  AddSweetItemsPage({this.food});

  @override
  _AddSweetItemsPageState createState() => _AddSweetItemsPageState();
}

class _AddSweetItemsPageState extends State<AddSweetItemsPage> {
  String title;
  String category;
  String description;
  String price;
  ...
  var productLatLocation;
  var productLngLocation;
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              widget.food != null ? "Update Food Item" : "Add Sweet Item",
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 16.0,
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    _buildTextFormField("Sweet Title"),
