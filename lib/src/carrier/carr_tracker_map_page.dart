...
class CarTrackerMapPage extends StatefulWidget {
  final String add;
  CarTrackerMapPage({this.add});
  @override
  _CarTrackerMapPageState createState() => _CarTrackerMapPageState();
}

class _CarTrackerMapPageState extends State<CarTrackerMapPage> {
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      List<Placemark> destinationPlacemark =
          await _geolocator.placemarkFromAddress('${widget.add}');
