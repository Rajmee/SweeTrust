...
import 'package:sweet_trust/src/widgets/history_details_card.dart';
...
class CarHistoryDetailsPage extends StatefulWidget {
  final Request request;

  // final DocumentSnapshot post;
  CarHistoryDetailsPage(this.request);

  @override
  _CarHistoryDetailsPageState createState() => _CarHistoryDetailsPageState();
}

class _CarHistoryDetailsPageState extends State<CarHistoryDetailsPage> {
